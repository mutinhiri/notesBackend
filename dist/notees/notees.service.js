...
exports.NoteesService = void 0;
const common_1 = require("@nestjs/common");
const database_service_1 = require("../database/database.service");
let NoteesService = class NoteesService {
    databaseService;
    constructor(databaseService) {
        this.databaseService = databaseService;
    }
    async create(createNoteeDto) {
    ...
    async update(id, updateNoteeDto) {
...
exports.NoteesService = NoteesService;
exports.NoteesService = NoteesService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [database_service_1.DatabaseService])
], NoteesService);
//# sourceMappingURL=notees.service.js.map